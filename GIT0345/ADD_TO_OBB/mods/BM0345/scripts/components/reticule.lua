...
function Reticule:SetValidateFn(fn)
	self.validatefn = fn
end

function Reticule:NeedsValidation()
	return self.validatefn ~= nil
end

function Reticule:Validate()
	if self.validatefn then
		return self.validatefn(self.inst)
	end
...
function Reticule:CreateReticule()
	...
	reticule:AddTag("INTERIOR_LIMBO_IMMUNE")
