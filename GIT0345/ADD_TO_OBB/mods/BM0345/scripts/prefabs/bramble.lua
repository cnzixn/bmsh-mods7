local assets=
{
	...
	Asset( "ATLAS", "images/inventoryimages/bramble.xml"),
	Asset( "ATLAS", "images/inventoryimages/bramble_core.xml"),
}
...
local function propegateHedge(inst)	
	...
	if sm:GetSeason() == SEASONS.SPRING then
...
local function hedgefn()
	...
	inst.MiniMapEntity:SetIcon( "bramble.tex" )
