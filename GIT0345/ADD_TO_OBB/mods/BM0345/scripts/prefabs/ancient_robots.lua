...
local assets=
{
  ...
  Asset( "ATLAS", 'images/inventoryimages/ancient_robot_claw.xml'),
  Asset( "ATLAS", 'images/inventoryimages/ancient_robot_head.xml'),
  Asset( "ATLAS", 'images/inventoryimages/ancient_robot_leg.xml'),
  Asset( "ATLAS", 'images/inventoryimages/ancient_robot_ribs.xml'),
}
...
local function commonfn(Sim)
    ...
    minimap:SetIcon("ancient_robot_ribs.tex")
...
local function armfn(Sim)
    ...
    local inst = commonfn(Sim)
    inst.MiniMapEntity:SetIcon( "ancient_robot_claw.tex" )
    inst.collisionradius = 1.2
    MakeCharacterPhysics(inst, 99999, inst.collisionradius)
...
local function legfn(Sim)
    ...
    local inst = commonfn(Sim)
    inst.MiniMapEntity:SetIcon( "ancient_robot_leg.tex" )
    inst.collisionradius = 1.2
    MakeCharacterPhysics(inst, 99999, inst.collisionradius)
...
local function headfn(Sim)
    ...
    local inst = commonfn(Sim)
    inst.MiniMapEntity:SetIcon( "ancient_robot_head.tex" )
    inst.collisionradius = 2
    MakeCharacterPhysics(inst, 99999, inst.collisionradius)
