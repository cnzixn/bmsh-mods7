...
local function fn(Sim)
    ...
    inst.components.herd:SetMemberTag("scorpion")
    ...
    inst.components.periodicspawner:SetPrefab("scorpion")
...
return Prefab( "forest/animals/scorpion_herd", fn, assets, prefabs) 
