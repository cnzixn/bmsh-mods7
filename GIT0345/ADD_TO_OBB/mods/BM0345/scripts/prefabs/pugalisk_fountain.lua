local assets =
{
  ...
  Asset( "ATLAS", 'images/inventoryimages/pugalisk_fountain.xml'),    
}
...
local function reset(inst)
    ...
    inst.SoundEmitter:KillSound("burble")
    inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/pugalisk/fountain_LP", "burble")
...
return Prefab("pugalisk_fountain", fn, assets, prefabs),
      MakePlacer("common/pugalisk_fountain_placer", "fountain", "python_fountain", "off")
