...
return Prefab("city_lamp", fn, assets),
  MakePlacer("city_lamp_placer", "lamp_post", "lamp_post2_city_build", "idle", false, false, true)  --放置类似墙
  --MakePlacer("city_lamp_placer", "lamp_post", "lamp_post2_city_build", "idle")  --放置类似建筑
