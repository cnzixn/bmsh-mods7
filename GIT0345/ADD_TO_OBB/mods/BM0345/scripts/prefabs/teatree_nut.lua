...
Asset("ANIM", "anim/teatree_nut.zip"),
    Asset("ATLAS", "images/inventoryimages/teatree_nut.xml"),
    Asset("ATLAS", "images/inventoryimages/teatree_nut_cooked.xml"),
}
...
local function test_ground(inst, pt)
	...
	local ground_OK = tiletype ~= GROUND.ROCKY and tiletype ~= GROUND.ROAD and tiletype ~= GROUND.IMPASSABLE and
						...
						tiletype ~= GROUND.CARPET and tiletype ~= GROUND.LEAKPROOFCARPET and tiletype ~= GROUND.CHECKER and tiletype < GROUND.UNDERGROUND
...
local function fn()
 ...
 inst.components.inventoryitem.imagename = "teatree_nut"
	inst.components.inventoryitem.atlasname = "images/inventoryimages/teatree_nut.xml"
...
local function cooked()
    ...
    inst:AddComponent("inventoryitem")
 inst.components.inventoryitem.imagename = "teatree_nut_cooked"
	inst.components.inventoryitem.atlasname = "images/inventoryimages/teatree_nut_cooked.xml"
