...
local assets =
{
    jellybug = { Asset("ANIM", "anim/jellybug.zip"), Asset("ATLAS", "images/inventoryimages/jellybug.xml"), },
    slugbug = { Asset("ANIM", "anim/slugbug.zip"), Asset("ATLAS", "images/inventoryimages/slugbug.xml"), },

    jellybug_cooked = { Asset("ANIM", "anim/jellybug_cooked.zip"), Asset("ATLAS", "images/inventoryimages/jellybug_cooked.xml"), },
    slugbug_cooked = { Asset("ANIM", "anim/slugbug_cooked.zip"), Asset("ATLAS", "images/inventoryimages/slugbug_cooked.xml"), },
}
...
local function slugbug_raw()
    ...
    inst:AddComponent("inventoryitem")
    inst.components.inventoryitem.imagename = "slugbug"
	   inst.components.inventoryitem.atlasname = "images/inventoryimages/slugbug.xml"
