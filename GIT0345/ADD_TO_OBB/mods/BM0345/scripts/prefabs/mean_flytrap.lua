...
local assets=
{
	...
	Asset( "ATLAS", "images/inventoryimages/mean_flytrap.xml"),
...
local function retargetfn(inst)
	...
	local notags = {"FX", "NOCLICK","INLIMBO", "wall", "flytrap", "structure", "aquatic", "penguin"}
...
--繁殖？
  ...
  inst.components.herdmember:SetHerdPrefab("mean_flytrap_herd")
----
