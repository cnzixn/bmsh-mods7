...
local assets=
{
 ...
 Asset( "ATLAS", 'images/inventoryimages/floweroflife.xml'),
}
...
local function fn(Sim)
	...
	inst.MiniMapEntity:SetIcon( "floweroflife.tex" )
...
local function sparklefn(Sim)
    ...
    --MakeNoPhysics(inst, 1, 0.3) --原
    MakeObstaclePhysics(inst, 1, 0.3) --测试
    RemovePhysicsColliders(inst)
