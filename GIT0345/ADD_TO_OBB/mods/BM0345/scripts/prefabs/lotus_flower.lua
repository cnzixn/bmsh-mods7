local assets =
{
	Asset("ANIM", "anim/lotus.zip"),
 	Asset("ATLAS", "images/others/lotus_flower.xml"),
 	Asset("ATLAS", "images/others/lotus_flower_cooked.xml"),
...
local function fn(Sim)
    ...
    inst.components.inventoryitem.imagename = "lotus_flower"
   	inst.components.inventoryitem.atlasname = "images/others/lotus_flower.xml"
...
local function fncooked(Sim)
    ...
    inst.components.inventoryitem.imagename = "lotus_flower_cooked"
   	inst.components.inventoryitem.atlasname = "images/others/lotus_flower_cooked.xml"
