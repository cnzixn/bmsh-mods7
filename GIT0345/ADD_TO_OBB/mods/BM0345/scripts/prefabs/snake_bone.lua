local assets = 
{
	...
	Asset( "ATLAS", 'images/inventoryimages/snake_bone.xml'),
}

STRINGS.NAMES.SNAKE_BONE = "蛇骨"
STRINGS.RECIPE_DESC.SNAKE_BONE = "测试专用"
...
local function fn()
    ...
    inst.components.inventoryitem.atlasname = 'images/inventoryimages/snake_bone.xml'
