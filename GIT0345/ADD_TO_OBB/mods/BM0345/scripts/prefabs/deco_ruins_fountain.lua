local assets =
{
 ...
 Asset( "ATLAS", "images/map_icons/deco_ruins_fountain.xml"),  
}
        ...
        inst:DoTaskInTime(1, function()
                ...
                elseif value < 200 then
                       ...
                       --送给你们的额外奖励
				               	   ...
				               	   local herald = SpawnPrefab("ancient_herald")
					                  herald.Transform:SetPosition(x+1, y, z+1)
                end
...
local function decofn(build, bank, animframe, data )
    ...
    local function fn(Sim)
        ...
        minimap:SetIcon("deco_ruins_fountain.tex")
        ...
        if data and data.vortex then
            ...
            minimap:SetIcon("deco_ruins_endswell.tex")
        end
        ...
        anim:SetTime(math.random() * 1) --anim:GetCurrentAnimationLength())
