...
local assets =
{
	...
	Asset( "ATLAS", "images/inventoryimages/piko.xml"),
	Asset( "ATLAS", "images/inventoryimages/piko_orange.xml"),
...
--[[
	...
	inst.components.inventoryitem.imagename = "piko"
	
	inst.components.inventoryitem.atlasname = "images/inventoryimages/piko.xml"
...
local function orangefn()
	...
	inst.components.inventoryitem.imagename = "piko_orange"
	
	inst.components.inventoryitem.atlasname = "images/inventoryimages/piko_orange.xml"
