...
local assets = {
    ...
    Asset("IMAGE", "images/inventoryimages/hamletturfs.tex"),
    Asset("ATLAS", "images/inventoryimages/hamletturfs.xml"),
}
...
--[[
        ...
        inst.components.inventoryitem.atlasname = "images/inventoryimages/hamletturfs.xml"
