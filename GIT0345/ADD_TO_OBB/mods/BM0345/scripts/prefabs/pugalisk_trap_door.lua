local assets =
{
 ...
 Asset( "ATLAS", 'images/inventoryimages/pugalisk_trap_door.xml'),
...
local function spawnpugalisk(inst)
    ...
    if not ent then
        inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/pugalisk/entrance")
...
--[[
    ...
    if inst.state == STATES.CLOSED then        
        ...
        inst.AnimState:PlayAnimation("opening")
        inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/pugalisk/trap_door")
...
local function fn(Sim)
    ...
    --local minimap = inst.entity:AddMiniMapEntity()
       --minimap:SetIcon( "pugalisk_trap_door.tex" )
