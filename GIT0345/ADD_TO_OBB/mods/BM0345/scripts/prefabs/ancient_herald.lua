...
local function fn(Sim)
    ...
    inst.components.locomotor.walkspeed = 2 --TUNING.GHOST_SPEED
    inst.components.locomotor.runspeed = 2 --TUNING.GHOST_SPEED
    ...
    inst.components.health:SetMaxHealth(2000) --(TUNING.DEERCLOPS_HEALTH)
    inst.components.health.destroytime = 3

    ------------------
    
    inst:AddComponent("combat")
    inst.components.combat:SetDefaultDamage(50) --(TUNING.ANCIENT_HERALD_DAMAGE)
