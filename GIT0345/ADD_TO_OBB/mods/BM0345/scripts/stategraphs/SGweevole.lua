...
local states =
{
    State{
        ...
        onenter = function(inst)
            inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/weevole/death")
    ...
    State{
        ...
        timeline=
        {
            TimeEvent(0*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/weevole/walk") end),         
            TimeEvent(3*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/weevole/walk") end),
            TimeEvent(6*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/weevole/walk") end),
         },
    ...
    State{
        ...
        timeline=
        {
            ...
            TimeEvent(10*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/weevole/idle") end),
         },
    ...
    State{
        ...
        timeline =
        {
            TimeEvent(5 * FRAMES, function(inst) 
                inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/weevole/burrow", "move")
            end),
    ...
    State{
        ...
        onenter = function(inst)
         ...
         timeline=
        {
            TimeEvent(8*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/weevole/taunt") end),         
    ...
    State{
        ...
        timeline=
        {
            ...
            TimeEvent(8*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/weevole/attack") end),
    ...
    State{
        ...
        timeline =
        {
            TimeEvent(7*FRAMES, function(inst) 
                inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/weevole/fly_LP", "buzz")
            end),
            TimeEvent(17*FRAMES, function(inst) 
                inst.SoundEmitter:KillSound("buzz")
                inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/weevole/idle")
            end),
    ...
    State{
        ...
        onenter = function(inst)
            inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/weevole/hit")
