...
if not TheInput:ControllerAttached() then --改，触屏的单独提出来
    ...
    if inst.fullcharge and TheInput:ControllerAttached() then --改，手柄。多了个手柄判定
        ...
        beam.components.combat.proxy = inst
        beam.owner = inst    
    elseif TheInput:ControllerAttached() then --改，手柄。避免和触屏冲突，又加了个判定
        local player = GetPlayer()
        local rotation = player.Transform:GetRotation()
    ...
    EventHandler("beginchargeup", 
        function(inst) 
            if not inst.sg:HasStateTag("busy") then
              ...
              if not TheInput:ControllerAttached() then --1改，触屏的
                inst:DoTaskInTime(0.8, function()
                  inst.sg:GoToState("chagefull")
                end)
...
local states=
{
    ...
    State {
        ...
        timeline=
        {
            ...
            TimeEvent(15*FRAMES, function(inst) 
                ...
                inst.SoundEmitter:PlaySound("Hamlet/common/crafted/iron_lord/morph")
            end),
    ...
    State{
        ...
        timeline=
        {
            TimeEvent(8*FRAMES, function(inst) 
                ...
                inst.SoundEmitter:PlaySound("Hamlet/common/crafted/iron_lord/punch",nil,.5)
            end),
    ...
    State{
        ...
        onupdate = function(inst)        
            ...
            if inst.shoot and inst.readytoshoot then
                ...
                inst.SoundEmitter:PlaySoundWithParams("Hamlet/common/crafted/iron_lord/smallshot", {timeoffset=math.random()})
    ...
    State{
        ...
        onupdate = function(inst)
            ...
            if inst.shoot and inst.readytoshoot then
                ...
                inst.SoundEmitter:PlaySoundWithParams("Hamlet/creatures/enemy/metal_robot/laser",  {intensity = math.random(0.7, 1)})
    ...
    State{
        ...
        {   ---- death explosion
            ...
            --]]
            TimeEvent(4*FRAMES, function(inst) print ("4") inst.SoundEmitter:PlaySoundWithParams("Hamlet/creatures/enemy/metal_robot/electro", {intensity= .2}) end),
            TimeEvent(8*FRAMES, function(inst) print ("8") inst.SoundEmitter:PlaySoundWithParams("Hamlet/creatures/enemy/metal_robot/electro", {intensity= .4}) end),
            TimeEvent(12*FRAMES, function(inst) print ("12") inst.SoundEmitter:PlaySoundWithParams("Hamlet/creatures/enemy/metal_robot/electro", {intensity= .6}) end),
            TimeEvent(19*FRAMES, function(inst) print ("19") inst.SoundEmitter:PlaySoundWithParams("Hamlet/creatures/enemy/metal_robot/electro", {intensity= 1}) end),
            TimeEvent(26*FRAMES, function(inst) print ("26") inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/electro",nil,.5) end),
            TimeEvent(35*FRAMES, function(inst) print ("35") inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/electro",nil,.5) end),
            TimeEvent(54*FRAMES, function(inst) print ("54") inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/electro") end),
...
CommonStates.AddCombatStates(states,
{
    ...
    attacktimeline = 
    {
        ...
        TimeEvent(8*FRAMES, function(inst) 
            ...
            inst.SoundEmitter:PlaySound("Hamlet/common/crafted/iron_lord/punch") end),
