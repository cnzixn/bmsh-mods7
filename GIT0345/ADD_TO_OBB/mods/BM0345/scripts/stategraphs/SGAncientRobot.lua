...
--------------------------------------------- leg
            TimeEvent(12*FRAMES, function(inst) 
                if inst:HasTag("robot_leg") then
                   inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/leg/servo")
                end
            end),
            TimeEvent(12*FRAMES, function(inst) 
                if inst:HasTag("robot_leg") then
            ...
            TimeEvent(27*FRAMES, function(inst) 
                if inst:HasTag("robot_leg") then
                   inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/leg/servo_small",nil,0.5)
                end
            end),
            ...
            TimeEvent(45*FRAMES, function(inst) 
                if inst:HasTag("robot_leg") then
                   inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/leg/servo",nil,0.6)
                end
            end),
        },   
--------------------------------------------- arm/claw
...
--                inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/boss/hulk_metal_robot/explode_small",nil,.25)
                inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/head/step")
                pt.y = 0                
                inst.Physics:Stop()
...
--------------------------------------------- leg
            TimeEvent(6*FRAMES, function(inst) 
                if inst:HasTag("robot_leg") then
                   inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/electro",nil,0.5)
                end
            end),
...
--------------------------------------------- arm/claw
            TimeEvent(3*FRAMES, function(inst) 
                if inst:HasTag("robot_arm") then
                    inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/arm/active")
                    inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/arm/start")
                end
            end),
            ...
            TimeEvent(37*FRAMES, function(inst) 
                if inst:HasTag("robot_arm") then
                   inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/arm/servo") 
                end
            end),
            TimeEvent(30*FRAMES, function(inst) 
                if inst:HasTag("robot_arm") then
...
--------------------------------------------- head
            TimeEvent(0*FRAMES, function(inst) 
                if inst:HasTag("robot_head") then
                   inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/head/active")
                   inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/head/start")
                end
            end),
            ...
            TimeEvent(0*FRAMES, function(inst) 
                if inst:HasTag("robot_leg") then
                    inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/leg/active")
                    inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/leg/start")
                end
            end),
            ...
            TimeEvent(58*FRAMES, function(inst) 
                if inst:HasTag("robot_leg") then
                   inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/leg/step",nil,.06)
                end
            end),
            --------------------------------------------- ribs
            TimeEvent(2*FRAMES, function(inst) 
                if inst:HasTag("robot_ribs") then
                   inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/ribs/active")
                   inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/ribs/start")
                end
            end),
    ...
    State{
        ...
        onenter = function(inst, pushanim)
           ...
           -- inst.wantstodeactivate = nil
            ...
            if inst:HasTag("robot_arm") then 
                inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/arm/stop")
                end
            if inst:HasTag("robot_head") then 
                inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/head/stop")
                end
            if inst:HasTag("robot_leg") then 
                inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/leg/stop")
                end
            if inst:HasTag("robot_ribs") then 
                inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/ribs/stop")
                end
...
--------------------------------------------- arm/claw
            TimeEvent(0*FRAMES, function(inst) 
                if inst:HasTag("robot_arm") then
                   inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/arm/green")
                end
            end),
            TimeEvent(9*FRAMES, function(inst) 
                if inst:HasTag("robot_arm") then
...
--------------------------------------------- head
            TimeEvent(5*FRAMES, function(inst) 
                if inst:HasTag("robot_head") then
                   inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/head/green")
                end
            end),
            TimeEvent(13*FRAMES, function(inst) 
                if inst:HasTag("robot_head") then
...
--------------------------------------------- leg
            TimeEvent(3*FRAMES, function(inst) 
                if inst:HasTag("robot_leg") then
                   inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/leg/green")
                end
            end),
            TimeEvent(12*FRAMES, function(inst) 
                if inst:HasTag("robot_leg") then
            ...
            TimeEvent(43*FRAMES, function(inst) 
                if inst:HasTag("robot_leg") then
                   inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/leg/step")
                end
            end),
    --------------------------------------------- ribs
            TimeEvent(0*FRAMES, function(inst) 
                if inst:HasTag("robot_ribs") then
                   inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/ribs/green")
                end
            end),
            TimeEvent(9*FRAMES, function(inst) 
                if inst:HasTag("robot_ribs") then
...
--------------------------------------------- arm/claw
            ...
            TimeEvent(15*FRAMES, function(inst) 
                if inst:HasTag("robot_arm") then
                   inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/arm/taunt")
                end
            end),
...
--------------------------------------------- ribs
            TimeEvent(4*FRAMES, function(inst) 
                if inst:HasTag("robot_ribs") then
                   inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/ribs/servo")
                end
            end),
            TimeEvent(17*FRAMES, function(inst) 
                if inst:HasTag("robot_ribs") then
            ...
            TimeEvent(21*FRAMES, function(inst) 
                if inst:HasTag("robot_ribs") then
                   inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/ribs/taunt")
                end
            end),
            TimeEvent(45*FRAMES, function(inst) 
                if inst:HasTag("robot_ribs") then
...
--------------------------------------------- leg
            ...
            TimeEvent(0*FRAMES, function(inst) 
                if inst:HasTag("robot_head") then
                   inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/head/servo")
                end
            end),
            TimeEvent(2*FRAMES, function(inst) 
                if inst:HasTag("robot_head") then
                    inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/head/taunt")
                end
            end),
            TimeEvent(12*FRAMES, function(inst) 
                if inst:HasTag("robot_head") then
                    inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/head/step","steps")
    ...
    State{
     ...
     --       EnableEightFaced(inst)
        ...
        timeline =
        {
            ...
            TimeEvent(7*FRAMES, function(inst) 
                if inst:HasTag("robot_arm") then
                   inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/laser_pre")
                end
            end),
            ...
            TimeEvent(30*FRAMES, function(inst) 
                if inst:HasTag("robot_arm") then
                   inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/laser","laserfilter")
            ...
            TimeEvent(47*FRAMES, function(inst) 
                if inst:HasTag("robot_arm") then
                   inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/arm/step")
                end
            end),
            --------------------------------------------- ribs
            TimeEvent(4*FRAMES, function(inst) 
...
--------------------------------------------- head
            TimeEvent(0*FRAMES, function(inst) 
             ...
             TimeEvent(3*FRAMES, function(inst) 
                 if inst:HasTag("robot_head") then
                    inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/head/attack")
                 end
             end),
...
--------------------------------------------- leg
            TimeEvent(2*FRAMES, function(inst) 
                if inst:HasTag("robot_leg") then
                   inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/smash")
                end
            end),
            TimeEvent(12*FRAMES, function(inst) 
                if inst:HasTag("robot_leg") then
...
CommonStates.AddWalkStates(
    states,
    {
        walktimeline = 
        {
            ...
            -- TimeEvent(6*FRAMES, function(inst)       
            --     if inst:HasTag("robot_ribs") then
            --        inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/ribs/step" "steps")
...
CommonStates.AddRunStates(
    states,
    {
        starttimeline = 
        {
            -- TimeEvent(0*FRAMES, function(inst)       
            --         if inst:HasTag("robot_leg") then
            --            inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/leg/step", "steps")
            --            inst.SoundEmitter:SetParameter("steps", "intensity", math.random())
            --         end
...
--------------------------------------------- head
                TimeEvent(0*FRAMES, function(inst)                                          
                    if inst:HasTag("robot_head") then
                       inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/head/servo","servo")
...
runtimeline = 
        {
                TimeEvent(0*FRAMES, function(inst) 
                    ...
                    if inst:HasTag("robot_arm") then
                        inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/arm/servo","servo")
                        inst.SoundEmitter:SetParameter("servo", "intensity", math.random())
                        inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/arm/drag")
                        inst.SoundEmitter:SetParameter("servo", "intensity", math.random())                        
                    end
                end ),
                ...
                TimeEvent(5*FRAMES, function(inst)    
                    if inst:HasTag("robot_leg") then
                       inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/leg/servo",nil,0.8)
                    end
                end),

                TimeEvent(6*FRAMES, function(inst)   
                    if inst:HasTag("robot_arm") then
                        inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/arm/step","steps")
                        inst.SoundEmitter:SetParameter("steps", "intensity", math.random())
                    end                                                       
                    if inst:HasTag("robot_ribs") then
                        inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/ribs/step","steps")
                        inst.SoundEmitter:SetParameter("steps", "intensity", math.random())
                        inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/ribs/servo","servo")
                        inst.SoundEmitter:SetParameter("servo", "intensity", math.random())
                    end
                end),
                ...
                TimeEvent(16*FRAMES, function(inst)                                         
                    if inst:HasTag("robot_ribs") then
                        inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/ribs/step_wires","steps")
                        inst.SoundEmitter:SetParameter("steps", "intensity", math.random())
                        inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/ribs/servo","servo")
                        inst.SoundEmitter:SetParameter("servo", "intensity", math.random())
                    end
    ...
    true,
    {
        startenter = function(inst)
            if inst:HasTag("ribs") then
                print("CHECK 2")
                --inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/metal_robot/ribs/step","robo_walk_LP")
            end
        end,
        --[[
