...
local states=
{
    ...
    State{
		...
		timeline=
		{
			TimeEvent(10*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/venus_flytrap/4/taunt") end),
    ...
    State{
        ...
        timeline=
        {
            ...
            TimeEvent(5*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/venus_flytrap/4/attack_pre") end),

            TimeEvent(14*FRAMES, function(inst) 
                if inst.components.combat.target then 
                    inst:ForceFacePoint(inst.components.combat.target:GetPosition()) 
                end 
                inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/venus_flytrap/4/attack") 
            end),
	...
	State{
        ...
        timeline=
		{
			TimeEvent(1*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/venus_flytrap/4/death_pre",nil,.5) end),
			TimeEvent(10*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/venus_flytrap/4/death") end),
		},
        events =
        {
            EventHandler("animover", function(inst) 
    ...
    State{
        ...
        onenter = function(inst)
            ...
            inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/venus_flytrap/4/breath_out")
        end,
    ...
    State{
        ...
        onenter = function(inst, target)
            inst.Physics:Stop()
            inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/venus_flytrap/4/breath_out")
            inst.SoundEmitter:PlaySound("Hamlet/creatures/enemy/venus_flytrap/4/death_pre")
