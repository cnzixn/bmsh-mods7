...
function SpawnFireRain(inst) --陨石
...
function SpawnGhosts(inst) --灵魂
	SpawnRandomInRange(inst,"ghost", 4, 6, 10) --pigghost
end

function SpawnNightmares(inst) --暗影
...
function SpawnFrogRain(inst) --青蛙
	...
	inst.frograintask = inst:DoPeriodicTask(0.2, 
		function() 
			local objs = SpawnRandomInRange(inst, "frog", 1, 4, 8, 35)
...
local states =
{
    ...
    State
    {
        ...
        timeline=
        {
            ...
            TimeEvent(0*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/ancient_herald/appear") end),
        },
    ...
    State
    {
        ...
        timeline=
        {
            ...
            TimeEvent(0*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/ancient_herald/taunt") end),
        },
    ...
    State
    {
        ...
        timeline=
        {
            ...
            TimeEvent(0*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/ancient_herald/summon") end),
            TimeEvent(1*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/ancient_herald/summon_2d") end),
...
CommonStates.AddCombatStates(states,
{
    ...
    attacktimeline =
    {
        ...
        TimeEvent(0*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/ancient_herald/attack") end),
        TimeEvent(1*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/ancient_herald/attack_2d") end),
    ...
    hittimeline = 
    {
        ...
        TimeEvent(0*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/ancient_herald/hit") end),
    },
    deathtimeline = 
    {
        --TimeEvent(0*FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/creatures/boss/ancient_herald/death") end),
        TimeEvent(0*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/ancient_herald/death") end),
...
CommonStates.AddWalkStates(states,
{
    walktimeline = 
    {
        ...
        TimeEvent(0*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/ancient_herald/breath_in") end),
        TimeEvent(17*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/ancient_herald/breath_out") end),   
    }
})
