...
local states=
{
    ...
    State{
        ...
        timeline=
        {
            ...
            TimeEvent(18*FRAMES, function(inst)inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/antqueen/taunt")end),
        },
    ...
    State{
        ...
        timeline=
        {
            ...
            TimeEvent(1*FRAMES, function(inst)inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/antqueen/atk_2_fly") end),
            TimeEvent(7*FRAMES, function(inst)inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/antqueen/atk_2_VO") end),
            TimeEvent(21*FRAMES, function(inst)inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/antqueen/land") end),
            TimeEvent(24*FRAMES, function(inst) GetWorld().components.quaker:ForceQuake("queenattack") end),
        },
    ...
    State{
        ...
        {   
            ...
            TimeEvent(1*FRAMES, function(inst)inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/antqueen/atk_1_rumble") end),
            TimeEvent(18*FRAMES, function(inst)inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/antqueen/atk_1_pre") end),
            TimeEvent(20*FRAMES, function(inst)inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/antqueen/atk_1") end),
    ...
    State{
        ...
        onenter = function (inst)
            ...
            inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/antqueen/atk_3_breath_in")
        end,
        ...
        timeline = 
        {
            ...
            TimeEvent(5*FRAMES, function (inst)  inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/antqueen/atk_3_breath_in") end),
            TimeEvent(22*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/antqueen/insane_LP","insane") end),
...
--]]
            TimeEvent(6*FRAMES, function (inst)  inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/antqueen/death") end),
            TimeEvent(43*FRAMES, function (inst)  inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/antqueen/land") end),
    ...
    State{
        ...
        onenter = function(inst)
            ...
            inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/antqueen/hit")
...
CommonStates.AddSleepStates(states,
    {
        ...
        starttimeline = 
        {
            ...
            TimeEvent(35*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/antqueen/breath_out") end),
        },
        ...
        sleeptimeline = 
        {
            ...
            TimeEvent(6*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/antqueen/breath_in") end ),
            TimeEvent(36*FRAMES, function(inst) inst.SoundEmitter:PlaySound("Hamlet/creatures/boss/antqueen/breath_out") end ),
        },
    },
    {
